    ...
    <div className="text-white mx-5 my-[2em] ">
      ...
      >
        ...
        <p className="text-center text-gray-300 mb-10">
          Gone through the fire of admission season, UniBound Consulting became the new flame to guide students forward
        </p>
        ...
        <div className=" flex flex-col lg:flex-row gap-10 ">
          ...
          <p className="w-full lg:w-1/2 text-[15px] lg:text-[18px]">
              During last year's competitive college application season, 7 students banded together under the dome of Thomas Jefferson High School for Science and Technology, one of the most rigorous schools in the country. Through countless essay edits and suggestions of new ideas they helped each other get into their dream schools. Realizing how difficult the application process has become, they decided to start UniBound Consulting as a way to guide students through a more competitive atmosphere. Now, as the 2025 admission season closes, they are passionate to help other students achieve their dreams.
              <br></br><br></br>

              Unlike other consultancy businesses, UniBound Consulting is made up of a team who have just finished the college application process and know what it’s like to apply in a new, more competitive environment. Having just gone through the admissions process, our team is excited to share our experience and knowledge with others. We know what each person applying to schools is going through and can connect with students more easily.
              <br></br><br></br>
