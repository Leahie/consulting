...
export default function ContactUs() {
    ...
    return(
       ...
       <div>
        ...
        {/* Buttons*/}
        <div className='bg-slate-100 flex justify-center gap-5 pt-[2em] pb-[10em] text-white text-[15px] px-5'>
            ...
            <button className="cursor-pointer bg-slate-800 py-2 px-5 rounded " onClick={()=>handleOpen()}>Interest Form</button>
               ...
               <Dialog open={open} onClose={()=>handleOpen(null)} fullWidth maxWidth="lg" >
                ...
                <DialogActions>
                <Button variant="text" color="primary" onClick={() => handleOpen(null)}>
